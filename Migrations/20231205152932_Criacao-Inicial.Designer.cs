...
namespace LoginCliente.Migrations
{
    ...
    [Migration("20231205152932_Criacao-Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoginCliente.Models.Cidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginCliente.Models.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginCliente.Models.EntradaProduto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginCliente.Models.Estado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginCliente.Models.Fornecedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginCliente.Models.Pais", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginCliente.Models.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginCliente.Models.SaidaProduto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginCliente.Models.TipoProduto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginCliente.Models.TipoSaida", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginCliente.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LoginCliente.Models.Cidade", b =>
                {
                    b.HasOne("LoginCliente.Models.Estado", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("LoginCliente.Models.Cliente", b =>
                {
                    b.HasOne("LoginCliente.Models.Cidade", "Cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("LoginCliente.Models.EntradaProduto", b =>
                {
                    b.HasOne("LoginCliente.Models.Produto", "Produto")
                        .WithMany()
            ...
            modelBuilder.Entity("LoginCliente.Models.Estado", b =>
                {
                    b.HasOne("LoginCliente.Models.Pais", "Pais")
                        .WithMany()
            ...
            modelBuilder.Entity("LoginCliente.Models.Produto", b =>
                {
                    b.HasOne("LoginCliente.Models.Fornecedor", "Fornecedor")
                        .WithMany()
                        .HasForeignKey("FornecedorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LoginCliente.Models.TipoProduto", "TipoProduto")
                        .WithMany()
            ...
            modelBuilder.Entity("LoginCliente.Models.SaidaProduto", b =>
                {
                    b.HasOne("LoginCliente.Models.Cliente", "Cliente")
                        .WithMany()
                    ...
                    b.HasOne("LoginCliente.Models.TipoSaida", "TipoSaida")
                        .WithMany()
                        .HasForeignKey("TipoSaidaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LoginCliente.Models.Usuario", "Usuario")
                        .WithMany()
