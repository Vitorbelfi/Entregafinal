...
namespace LoginCliente.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoNome,ProdutoEstoque,FornecedorId,TipoProdutoId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoNome,ProdutoEstoque,FornecedorId,TipoProdutoId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
            }
            produto.ProdutoEstoque = 0;
            if (ModelState.IsValid)
            {
                try
                {
